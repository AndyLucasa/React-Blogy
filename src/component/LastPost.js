...
const LastPost = () => {
    return (
        <section id="home"className="LastPost pt-4 h-4/5">
            <p className="text-gray-900 justify-self-start cursor-pointer text-2xl flex items-center ml-6 no-underline font-thin font-righteous">Recent Article</p>
            <div className="h-3/4 md:h-full rounded-lg m-6 mt-2 bg-white shadow-xl">
