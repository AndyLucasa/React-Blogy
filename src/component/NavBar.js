...
const NabBar = () => {
    return (
        <>
            <div className="Nav bg-white h-12 w-screen flex justify-center items-center text-base sticky top-0 z-10 md:transition duration-75 ease-linear">
                <div className="NavBarContainer flex justify-between h-10 z-0 w-full p-6 max-w-5xl">
                    ...
                    <div className="NavMenu md:flex items-center list-none text-center -mr-6 hidden  ">
                        <div  className="NavItem h-12 pr-9">
