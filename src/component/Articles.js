...
const Articles = () => {
    return (
        <section id="article" className="Article sm:-mt-14 lg:mr-6 ">
            <p className="text-gray-900 justify-self-start cursor-pointer text-2xl flex items-center ml-6 no-underline font-thin font-righteous">Articles</p>
                ...
                <div className="Article1 md:inline-block h-32 m-6 rounded-xl shadow-md bg-white md:h-full md:w-72 flex items-center  md:mr-10 ">
                    ...
                    <div className="Text h-24 w-9/12 m-4 ml-28 pl-4 rounded-lg md:w-72 md:h-full md:ml-0 md:pr-2 md:pt-3">
                        <div className="Text flex flex-col justify-between">
                            <p className="uppercase tracking-tighter text-left font-poppins text-sm text-red-700 md:text-lg">Deco & Design</p>
                            <p className="mb-0 font-rubik text-xs text-gray-900 text-left mt-2 md:text-sm ">Tired of making holes in the walls to hang things? Discover 20 different ways to decorate them without drilling!.</p>
                        </div>
                    </div>
                </div>
            ...
            <div className="md:space-x-0">
                <div className="Article1 md:inline-block h-32 m-6 rounded-xl shadow-md bg-white md:h-full md:w-72 flex items-center  md:mr-10 ">
                    ...
                    <div className="Text h-24 w-9/12 m-4 ml-28 pl-4 rounded-lg md:w-72 md:h-full md:ml-0 md:pr-2 md:pt-3">
                        <div className="Text flex flex-col justify-between">
                            <p className="uppercase tracking-tighter text-left font-poppins text-sm text-red-700 md:text-lg">Creativity</p>
                            <p className="mb-0 font-rubik text-xs text-gray-900 text-left mt-2 md:text-sm ">Creativity is at the origin of discoveries and inventions, of art and culture, but it is not reserved to geniuses or artists.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="Article1 md:inline-block h-32 m-6 rounded-xl shadow-md bg-white md:h-full md:w-72 flex items-center md:mr-10 ">
                    ...
                    <div className="Text h-24 w-9/12 m-4 ml-28 pl-4 rounded-lg md:w-72 md:h-full md:ml-0 md:pr-2 md:pt-3">
                        <div className="Text flex flex-col justify-between">
                            <p className="uppercase tracking-tighter text-left font-poppins text-sm text-red-700 md:text-lg">Sport, Health & Wellness</p>
                            <p className="mb-0 font-rubik text-xs text-gray-900 text-left mt-2 md:text-sm ">Discover ten easily applicable tips that can dramatically improve the way you feel throughout the day.</p>
                        </div>
                    </div>
                </div>
            </div>
